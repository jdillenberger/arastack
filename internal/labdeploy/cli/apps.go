...
import (
	...
	"github.com/jdillenberger/arastack/internal/labdeploy/wizard"
	"github.com/jdillenberger/arastack/internal/labdeploy/repo"
...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if len(deployed) == 0 {
			...
			fmt.Println("No apps deployed. Use 'labdeploy list --all' to see available templates.")
			return nil
		}
