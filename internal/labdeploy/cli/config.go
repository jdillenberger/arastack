...
func init() {
	...
	configInitCmd.Flags().StringP("path", "p", "/etc/komphost/labdeploy.yaml", "Path for the config file")
}

var configCmd = &cobra.Command{
	Use:   "config",
	Short: "Manage configuration",
	Long:  "Show, set, initialize, and validate labdeploy configuration.",
}
...
var configSetCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if cfgPath == "" {
			cfgPath = "/etc/komphost/labdeploy.yaml"
		}
