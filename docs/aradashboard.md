...
| `ca.cert_path` | `{aradeploy.data_dir}/traefik/certs/ca.crt` | Path to the local CA certificate generated by aradeploy. Used on the CA trust page (`/ca`) for certificate display, download, and install script generation. |
