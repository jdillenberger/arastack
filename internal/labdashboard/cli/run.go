...
import (
	...
	"github.com/jdillenberger/arastack/internal/labdashboard/web"
...
func runDaemon() error {
	...
	if err != nil {
		return fmt.Errorf("reading labdeploy config: %w", err)
	}

	handlers.SetVersion(version.Version)

	slog.Info("starting labdashboard",
		"bind", cfg.Server.Bind,
		"port", cfg.Server.Port,
		"apps_dir", ldc.AppsDir,
		"labdeploy_config", cfg.LabdeployConfig,
	)

	srv, err := web.NewServer(&cfg, ldc)
	if err != nil {
	...
	slog.Info("labdashboard stopped")
	return nil
}
