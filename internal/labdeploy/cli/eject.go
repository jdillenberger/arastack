...
func init() {
	...
	ejectCmd.Flags().StringP("output", "o", "", "Output directory (default: ./labdeploy-eject)")
}
...
to a directory, so you can manage them without labdeploy.`,
